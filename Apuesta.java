...
public class Apuesta {
     ...
     * @param dinero, valor con el que se trabajará en la funcion
    *  @author alejandroM
    *  @version 1.1
     */
     ...
     * @param local, equipo local con el que se comprobará el otro equipo
     * @param visitante, equipo visitante con el que se comprará el anterior parametro para ver el ganador entre ambos
     * @author alejandroM
     * @version 1.1
     */
     ...
     * @param cantidad_goles_local, indica los goles del equipo local
     * @param cantidad_goles_visitantes, indica los goles del equipo visitante
     */
